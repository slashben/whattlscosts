...
TESTER_SMALL_MEDIUM_COMMAND="jmeter -n -t /test-extra/small_medium.jmx -q /test/user.properties -JThreads=4 -JHttpMethod=http -JDuration=120 -l /tmp/test_small_medium.jtl -e -o /tmp/test_small_medium_html"
